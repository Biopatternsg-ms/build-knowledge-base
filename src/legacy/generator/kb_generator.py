...
def get_normalized_kb(events: dict, entities: dict, objects_identities_: list) -> tuple:
    ...
    biotypes_path = root + "/output/biotypes-kbs" + "/biotypes.pl"
    identities_path = root + "/output/kb_objects.txt"
...
def print_kb(knowledge_base: dict, root: str) -> None:
    kb_path = root + "/output/kBase.pl"
    doc_kb_path = root + "/output/kBaseDoc.txt"
...
def print_synonyms(objects_synonyms: dict, root: str) -> None:
    synonyms_path = root + "/output/synonyms.pl"

    new_objects_path = root + "/output/objects_in_kb.txt"
...
def print_aligned_objs(root: str, synonyms_: dict, biopatternsg_directory: str) -> None:
    ...
    aligned_objects_path = root + "/output/aligned.pl"
...
def print_species_pubmed_ids(root: str, species_pubmed_ids: list, working_dir:str, species_names: list):
    ...
    species_pubmed_ids__path = root + "/output/species_pubmed_ids.txt"
...
if __name__ == '__main__':
    ...
    logs_files_path = root + '/output/logs'
    ...
    pubtators_biotypes_path = root + '/output/biotypes-kbs'
